  ...
  <body>
    <nav class="navbar navbar-expand-lg">
      <div class="container-fluid">
		...
		<%
		dataSetter data=(dataSetter)session.getAttribute("data");
		%>
    ...
    <div class="userAction">
      <div class="card" style="width: 18rem">
        <img
          src="Images/creditAmountPNG.png"
          class="card-img-top"
          alt="..."
        />
        <div class="card-body">
          ...
          <a href="creditAmountPaege.html" class="btn btn-primary"
            >Credit Amount</a
          >
        </div>
      </div>
      <div class="card" style="width: 18rem">
        ...
        <div class="card-body">
          ...
          <a href="" class="btn btn-primary">Debit Amount</a>
        </div>
      </div>
      <div class="card" style="width: 18rem">
        <img
      ...
      <div class="card" style="width: 18rem">
        ...
        <div class="card-body">
          ...
          <a href="DeleteAccount.html" class="btn btn-primary"
            >Delete Account</a
          >
        </div>
      </div>
