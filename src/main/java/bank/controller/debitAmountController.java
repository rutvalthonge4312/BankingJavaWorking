...
/**
 * Servlet implementation class debitAmountController
 */
@WebServlet("/debitAmountController")
public class debitAmountController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public debitAmountController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(rs.next()) {
				...
				try {
					dataSetter data=new dataSetter((currentAmount-amount), username, password);
